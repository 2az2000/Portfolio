    ...
    items: [
      {
        ...
        highlights: [
          ...
          "صدها اپ و ۵ میلیون کاربر؛ اسنپ و دیجی‌کالا و دیوار هم بینشونن",
        ],
    ...
    items: [
      {
        ...
        result:
          "کدبیسی که هم سریع‌تره هم راحت‌تر نگه داشته می‌شه، و الان یکی از اپ‌استورهای جایگزین ایران رو می‌چرخونه؛ با صدها اپ و ۵ میلیون کاربر (اسنپ، دیجی‌کالا، دیوار)، و یه پنل توسعه‌دهنده‌ی فعال.",
        stack: ["Next.js", "TypeScript", "PWA"],
        href: "https://sibirani.com",
      },
      {
        ...
        approach:
          "اول صف باگ‌ها رو خالی کردم تا بعداً هیچ مشکل قدیمی پای کار جدید نوشته نشه، بعد فیچرهای جدید رو روش ساختم: ثبت وعده از روی عکس و با صدا. مهاجرت وابستگی‌ها آخر از همه اومد و تیکه‌تیکه جلو رفت: اول اسم پکیج‌ها از ‎@material-ui‎ به ‎@mui‎، بعد بازنویسی همه‌ی makeStyles و withStyles با styled و sx در Emotion، بعد بردن تم نسخه‌به‌نسخه تا ۹، و آخر سر React تا ۱۹ با کنارگذاشتن findDOMNode و defaultProps و گرفتن ref به‌عنوان یه prop معمولی.",
        result:
        ...
        shipped: [
          ...
          "خالی‌کردن صف باگ‌ها پیش از هر کار جدیدی",
